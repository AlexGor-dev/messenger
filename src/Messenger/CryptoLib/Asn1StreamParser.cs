    ...
    public class Asn1StreamParser
    {
        ...
        internal IAsn1Convertible ReadIndef(int tagValue)
        {
            ...
            switch (tagValue)
            {
                ...
                default:
                    throw new Exception("unknown BER object encountered: 0x" + tagValue.ToString("X"));
            }
        }
        ...
        internal IAsn1Convertible ReadImplicit(bool constructed, int tag)
        {
            ...
            else
            {
                ...
                {
                    case Asn1Tags.Set:
                        throw new Exception("sequences must use constructed encoding (see X.690 8.9.1/8.10.1)");
                    case Asn1Tags.Sequence:
                        throw new Exception("sets must use constructed encoding (see X.690 8.11.1/8.12.1)");
                    case Asn1Tags.OctetString:
                        return new DerOctetStringParser((DefiniteLengthInputStream)_in);
                }
            }

            throw new Exception("implicit tagging not implemented");
        }
